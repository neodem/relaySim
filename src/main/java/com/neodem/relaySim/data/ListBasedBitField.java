 ...
 * Created on 3/13/16
 */
public class ListBasedBitField implements BitField {
     ...
     */
    public ListBasedBitField(BitField bitField) {
        this(bitField.size());
     ...
     */
    public ListBasedBitField(int size) {
    ...
    public static ListBasedBitField create(boolean... values) {
        ListBasedBitField result = new ListBasedBitField(values.length);
    ...
    public static ListBasedBitField create(int... values) {
        ListBasedBitField result = new ListBasedBitField(values.length);
        result.setBits(values);
        return result;
    }

    public static ListBasedBitField createFromInt(int value) {
        String bitstring = Integer.toString(value, 2);
        int size = bitstring.length();
        ListBasedBitField result = new ListBasedBitField(size);
        for (int i = 0; i < size; i++) {
    ...
    public static ListBasedBitField createFromHex(String hexString) {
        int fieldSize = 4 * hexString.length();
        int value = Integer.parseInt(hexString, 16);
        return createFromInt(value, fieldSize);
    }

    public static ListBasedBitField createFromHex(String hexString, int fieldSize) {
        int value = Integer.parseInt(hexString, 16);
        return createFromInt(value, fieldSize);
    }

    public static ListBasedBitField createFromInt(int value, int fieldSize) {
        ListBasedBitField result = ListBasedBitField.createFromInt(value);
     ...
     * @return
     */
    public static ListBasedBitField combine(BitField... fields) {
        ListBasedBitField result = new ListBasedBitField(fields[0]);
    ...
    public BitField getLSBs(int digits) {
        ...
        ListBasedBitField result = new ListBasedBitField(digits);
    ...
    public BitField getSubField(int from, int to) {
        ...
        ListBasedBitField result = new ListBasedBitField(requestedSize);
    ...
    public BitField copy() {
        return new ListBasedBitField(this);
    }
...
//        // if the field is less than 8, pad it with 0's and get byte and end
    ...
    public boolean equals(Object o) {
        ...
        ListBasedBitField bitField = (ListBasedBitField) o;
