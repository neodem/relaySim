...
public class Assembler {
    ...
    public MemoryBlock assemble(String assemblyProgram) {
        ...
        for (String line : lines) {
            ...
            else if (StringUtils.startsWith(line, "LDA"))
                handleLDA(new AsmParam(StringUtils.substringAfter(line, "LDA")));
            else if (StringUtils.startsWith(line, "ADC"))
                handleADC(new AsmParam(StringUtils.substringAfter(line, "ADC")));
            else if (StringUtils.startsWith(line, "STA"))
                handleSTA(new AsmParam(StringUtils.substringAfter(line, "STA")));
